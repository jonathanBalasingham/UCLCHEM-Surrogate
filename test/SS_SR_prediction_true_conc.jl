...
savefig(projectdir("images", "SS_SR_TC_prediction_RP_ESR.png"))
...
ESN.train!(esn, [X], [y], 2e-5)
ESN.train!(desn, [X], [y], 5e-6)
...
savefig(projectdir("images", "SS_SR_TC_prediction_RP_SCR.png"))
...
savefig(projectdir("images", "SS_SR_TC_prediction_RP_DLR.png"))
...
savefig(projectdir("images", "SS_SR_TC_prediction_RP_DLRF.png"))
