...
rates_set = sample_around(10, rfp, Parameters(phys_params...))
...
@info "Starting MAE Boxplots for Small Network"
...
savefig(projectdir("output", "MAE_Boxplots_SmallNetwork.png"))
@info "Done with MAE Boxplots"
...
boxplot!(errors[7], label="DLRF CTESN")
boxplot!(errors[8], label="DLRF Deep CTESN")
savefig(projectdir("output", "ROC_Boxplots_SmallNetwork.png"))
